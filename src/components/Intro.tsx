...
const Intro = () => {
  ...
  return (
    <section className="min-h-screen md:h-screen w-full flex flex-col justify-center items-center relative px-4 py-8 md:snap-start overflow-hidden">
      <motion.h2
      ...
      >
        Full-stack software engineer with experience in building scalable web and mobile apps using
        React, Node.js, and AWS. Proven track record of improving performance, usability, and
