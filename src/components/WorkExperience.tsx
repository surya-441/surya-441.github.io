    ...
    return (
        <section className="min-h-screen flex flex-col justify-center items-center relative px-4 py-8">
            ...
            <div className="relative ml-6">
                {/* vertical line */}
                <div className="absolute top-0 left-2 h-full w-0.5 bg-gray-300 dark:bg-gray-600" />

                <div className="space-y-12">
                    {experiences.map((exp, idx) => (
                        <div key={idx} className="relative pl-10">
                            {/* dot aligned to role */}
                            <div className="absolute left-0 top-[0.6em] w-4 h-4 bg-blue-500 rounded-full border-2 border-white dark:border-gray-900" />
                            {/* content */}
                            <div>
